...
export function BookCard({ book, variant = 'standard', onSelect, className }) {
  ...
  if (variant === 'carousel') {
    return (
      <Card 
        className={cn(
          "group cursor-pointer book-hover bg-card/50 backdrop-blur-sm border-0 shadow-lg",
          className
        )}
        ...
        <CardContent className="p-0">
          <div className="relative">
            ...
            <div className="absolute top-3 left-3 flex flex-col gap-2">
              {book.isNew && <Badge className="bg-green-500 text-white">New</Badge>}
              {book.isPopular && <Badge className="bg-red-500 text-white">Popular</Badge>}
              {book.isTrending && <Badge className="bg-orange-500 text-white">Trending</Badge>}
              {book.isRecommended && <Badge className="bg-blue-500 text-white">Recommended</Badge>}
            </div>
          ...
          <div className="p-4">
            <h3 className="font-crimson font-semibold text-lg leading-tight mb-1 line-clamp-2">
              {book.title}
            </h3>
